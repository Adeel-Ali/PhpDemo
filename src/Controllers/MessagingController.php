...
class MessagingController extends BaseController
{
    ...
    public function getSMSStatus(
        ...
        if ($response->code == 400) {
            throw new Exceptions\ErrorErrorErrorErrorException('Invalid or missing request parameters', $_httpContext);
        }

        if ($response->code == 401) {
            throw new Exceptions\ErrorErrorErrorErrorException(
        ...
        if ($response->code == 404) {
            throw new Exceptions\ErrorErrorErrorErrorException('The requested URI does not exist', $_httpContext);
        }
