...
class ProvisioningController extends BaseController
{
    ...
    public function deleteSubscription()
    {
        ...
        if ($response->code == 400) {
            throw new Exceptions\ErrorErrorError62Exception('Invalid or missing request parameters', $_httpContext);
        }

        if ($response->code == 401) {
            throw new Exceptions\ErrorErrorError62Exception(
        ...
        if ($response->code == 404) {
            throw new Exceptions\ErrorErrorError62Exception('The requested URI does not exist', $_httpContext);
        }
